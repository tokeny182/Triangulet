...
<html>
  ...
  <body>
    ...
    <div class="styles__topRightRow___dQvxc-camelCase">
      <div class="styles__profileContainer___CSuIE-camelCase" role="button" tabindex="0">
        <div class="styles__profileRow___cJa4E-camelCase">
          ...
          </div><text class="" style="color: #ffffff" id="usernamedrop">user</text>
        </div><i class="fas fa-angle-down styles__profileDropdownIcon___3iLIX-camelCase" aria-hidden="true"></i>
    ...
    <div class="styles__sidebar___1XqWi-camelCase">
      ...
      <a class="_button_552gk_1 _bigButton_l4eyq_22" href="play.html">
    ...
    <div class="_front_552gk_33" style="background-color: #53b721">
      ...
      <div class="nothin">
        <a class="styles__pageButton___1wFuu-camelCase" href="market.html">
        ...
        <a class="styles__pageButton___1wFuu-camelCase" href="trians.html">
        ...
        <a class="styles__pageButton___1wFuu-camelCase" href="leaderboard.html">
        ...
        <a class="styles__pageButton___1wFuu-camelCase" href="chat.html">
        ...
        <a class="styles__pageButton___1wFuu-camelCase" href="posts.html">
        ...
        <a class="styles__pageButton___1wFuu-camelCase" href="news.html">
        ...
        <a class="styles__pageButton___1wFuu-camelCase" href="auction.html">
      ...
      <div class="styles__bottomRow___3OozA-camelCase">
        ...
        <a data-tip="Stats" class="styles__smallButton___sQuq8-camelCase" href="https://discord.gg/8A6J234n7v" currentitem="false"><i class="styles__bottomIcon___3Fswk-camelCase fab fa-discord" aria-hidden="true"></i></a>
      </div>
    </div>
    <div class="arts__profileBody___eNPbH-camelCase">
      <div class="styles__header___153FZ-camelCase">News</div>
      <div class="styles__infoContainer___2uI-S-camelCase" style="width: 60%; max-width: 800px; padding: 20px;">

        <div class="styles__headerRow___1tdPa-camelCase">
          <div class="styles__infoHeader___1lsZY-camelCase">Triangulet Comeback?</div>
        </div>
        <div id="username" class="styles__text___1x37n-camelCase">
          New Triangulet website by PenguinPowers Himself
          <br>
          <a href="https://tri.pengpowers.xyz/">https://tri.pengpowers.xyz/</a>
          <br>
          Unfortunately it's already too late...
          <br>
          ⚠️ If it's back online then alert the <a href="https://discord.gg/8A6J234n7v">Discord Server</a> immediately ⚠️
          <br>
          <embed width="560" height="315" src="https://www.youtube.com/embed/U-CQVm4UMnY?si=rNeXztDVt0V6J4LQ" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen>
          <br>
          <img src="https://i.ibb.co/tmyvyKH/image.webp" alt="Screenshot" width="560">
          <p style="text-align: center;">Screenshot by knockback</p>
        </div>
      </div>
    </div>
  </body>
